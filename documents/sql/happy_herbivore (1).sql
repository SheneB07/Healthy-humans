...
(81, 'en', 'product.name.4', 'Tofu Power Tahini Bowl'),
(82, 'en', 'product.name.5', 'The Supergreen Harvest'),
(83, 'en', 'product.name.6', 'Mediterranean Falafel Bowl'),
(84, 'en', 'product.name.7', 'Oven-Baked Sweet Potato Wedges'),
(85, 'en', 'product.name.8', 'Zucchini Fries'),
(86, 'en', 'product.name.9', 'Baked Falafel Bites - 5pc'),
(87, 'en', 'product.name.10', 'Mini Veggie Platter & Hummus'),
(88, 'en', 'product.name.11', 'Zesty Chickpea Hummus Wrap'),
(89, 'en', 'product.name.12', 'Avocado & Halloumi Toastie'),
(90, 'en', 'product.name.13', 'Smoky BBQ Jackfruit Slider'),
(91, 'en', 'product.name.18', 'Classic Hummus'),
(92, 'en', 'product.name.19', 'Avocado Lime Dip'),
(93, 'en', 'product.name.20', 'Greek Yogurt Ranch'),
(94, 'en', 'product.name.21', 'Spicy Sriracha Mayo'),
(95, 'en', 'product.name.22', 'Peanut Satay Sauce'),
(96, 'en', 'product.name.25', 'Green Glow Smoothie'),
(97, 'en', 'product.name.26', 'Iced Matcha Latte'),
(98, 'en', 'product.name.27', 'Fruit-Infused Water'),
(99, 'en', 'product.name.28', 'Berry Blast Smoothie'),
(100, 'en', 'product.name.29', 'Citrus Cooler'),
(101, 'en', 'product.name.31', 'Overnight Oats: Apple Pie Style'),
(102, 'en', 'product.name.32', 'Warm Teriyaki Tempeh Bowl '),
(103, 'nl', 'product.name.1', 'Morning Boost açaí-bowl'),
(104, 'nl', 'product.name.2', 'Garden ontbijtwrap'),
(105, 'nl', 'product.name.3', 'Pindakaas & cacaotoast'),
(106, 'nl', 'product.name.4', 'Tofu power-tahinibowl'),
(107, 'nl', 'product.name.5', 'Supergroene oogst'),
(108, 'nl', 'product.name.6', 'Mediterrane falafelbowl'),
(109, 'nl', 'product.name.7', 'Ovengebakken zoete-aardappelpartjes'),
(110, 'nl', 'product.name.8', 'Courgettefrietjes'),
(111, 'nl', 'product.name.9', 'Gebakken falafelbites - 5 st.'),
(112, 'nl', 'product.name.10', 'Mini groenteschotel met hummus'),
(113, 'nl', 'product.name.11', 'Wrap met pittige kikkererwtenhummus'),
(114, 'nl', 'product.name.12', 'Avocado-halloumi tosti'),
(115, 'nl', 'product.name.13', 'Smoky BBQ jackfruit slider'),
(116, 'nl', 'product.name.18', 'Klassieke hummus'),
(117, 'nl', 'product.name.19', 'Avocado-limedip'),
(118, 'nl', 'product.name.20', 'Griekse yoghurt-ranchdip'),
(119, 'nl', 'product.name.21', 'Pittige sriracha-mayo'),
(120, 'nl', 'product.name.22', 'Pindasatésaus'),
(121, 'nl', 'product.name.25', 'Green Glow smoothie'),
(122, 'nl', 'product.name.26', 'Iced matcha latte'),
(123, 'nl', 'product.name.27', 'Fruit-infused water'),
(124, 'nl', 'product.name.28', 'Berry Blast smoothie'),
(125, 'nl', 'product.name.29', 'Citrus cooler'),
(126, 'nl', 'product.name.31', 'Overnight oats: appeltaartstijl'),
(127, 'nl', 'product.name.32', 'Warme teriyaki-tempehbowl'),
(128, 'en', 'menu.dip_recs.title', 'Try a dip with that?'),
(129, 'en', 'menu.dip_recs.subtitle', 'Great with:'),
(130, 'en', 'menu.dip_recs.subtitle_generic', 'These go great with your side:'),
(131, 'en', 'menu.dip_recs.close', 'No thanks'),
(132, 'en', 'menu.dip_recs.go_to_cart', 'Go to cart'),
(133, 'nl', 'menu.dip_recs.title', 'Lekker met een dip?'),
(134, 'nl', 'menu.dip_recs.subtitle', 'Lekker bij:'),
(135, 'nl', 'menu.dip_recs.subtitle_generic', 'Deze passen goed bij je bijgerecht:'),
(136, 'nl', 'menu.dip_recs.close', 'Nee bedankt'),
(137, 'nl', 'menu.dip_recs.go_to_cart', 'Naar winkelmandje'),
(138, 'en', 'checkout.print_receipt', 'Print receipt'),
(139, 'nl', 'checkout.print_receipt', 'Bon printen'),
(140, 'en', 'receipt.title', 'Receipt'),
(141, 'nl', 'receipt.title', 'Bon'),
(142, 'en', 'receipt.print_browser', 'Print receipt'),
(143, 'nl', 'receipt.print_browser', 'Bon printen'),
(144, 'en', 'receipt.print_usb', 'Print via USB'),
(145, 'nl', 'receipt.print_usb', 'Print via USB'),
(146, 'en', 'receipt.status_ready', 'Ready to print'),
(147, 'nl', 'receipt.status_ready', 'Klaar om af te drukken'),
(148, 'en', 'receipt.shop_name', 'Healthy Humans'),
(149, 'nl', 'receipt.shop_name', 'Healthy Humans'),
(150, 'en', 'receipt.thanks', 'Thank you!'),
(151, 'nl', 'receipt.thanks', 'Bedankt!'),
(152, 'en', 'receipt.total', 'Total'),
(153, 'nl', 'receipt.total', 'Totaal'),
(154, 'en', 'receipt.dine_label', 'Dining'),
(155, 'nl', 'receipt.dine_label', 'Eetmoment'),
(156, 'en', 'receipt.dine_in', 'Eat in'),
(157, 'nl', 'receipt.dine_in', 'Hier eten'),
(158, 'en', 'receipt.dine_out', 'Take out'),
(159, 'nl', 'receipt.dine_out', 'Meenemen'),
(160, 'en', 'menu.cancel.title', 'Cancel order?'),
(161, 'en', 'menu.cancel.confirm', 'Are you sure you want to cancel your order?'),
(162, 'en', 'menu.cancel.no', 'No'),
(163, 'en', 'menu.cancel.yes', 'Yes, cancel'),
(164, 'nl', 'menu.cancel.title', 'Bestelling annuleren?'),
(165, 'nl', 'menu.cancel.confirm', 'Weet je zeker dat je je bestelling wilt annuleren?'),
(166, 'nl', 'menu.cancel.no', 'Nee'),
(167, 'nl', 'menu.cancel.yes', 'Ja, annuleren');
